...
const Card = ({title,description,img,speakers,key}) => {
  ...
  return (
    <div key={key} class="rounded  border-2 overflow-hidden shadow-lg border-blue-900 flex flex-col justify-center items-center w-[298px] h-[380px] ">
      <div className="">
        <div class="overflow-hidden bg-white rounded shadow-md text-slate-500 shadow-slate-200">
          <figure>
            <Image
              ...
              src={img}
              alt="card image"
              class=" w-[298px] h-[180px]"
            />
          </figure>
          <div class="p-3 w-[298px] h-[200px]">
            <header class="mb-4">
