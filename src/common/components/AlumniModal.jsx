...
const AlumniModal = ({ alumni, onClose }) => {
    console.log(alumni)
  return (
    <div onClick={onClose} className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-white w-1/2 flex flex-col rounded-lg p-6">
        ...
        <div className="flex flex-col md:flex-row-reverse justify-between items-center md:items-start p-3">
            ...
            src={alumni.imageUrl}
            alt={alumni.name}
            className="w-[200px] h-[200px] object-contain ml-6 mr-4"
            />
