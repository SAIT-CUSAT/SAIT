    ...
    <div className="bg-transparent">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 flex gap-3 flex-col items-center md:flex-row">
          {hostels?.map((hostel) => (
            <Hostel_card contact_number={hostel.contact_number} location={hostel.location} key={hostel.hostel_name} hostel_name={hostel.hostel_name} imageUrl={hostel.imageUrl}  />
            // hostel container
            // <div
